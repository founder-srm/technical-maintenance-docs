...
- About Us Hero component with mission statements and values (exactly 3 required)
- Our Story section for organizational narrative and culture showcase
- Timeline component for chronological milestones and achievements
- Careers section management with job categories and openings
- Required vs optional field identification for each component
- Content writing guidelines for storytelling and professional presentation
</List>
...
- How to create compelling About Us hero sections with mission and values
- Our Story component setup for organizational narrative and culture
- Timeline management for showcasing key milestones and achievements
- Careers section organization with job categories and application links
- Required field management (especially the "exactly 3 values" rule)
- Content writing best practices for storytelling and professional presentation
- Button functionality requirements and link validation
- Image specifications and accessibility standards
</List>
